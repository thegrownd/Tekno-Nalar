<template>
  <Transition name="modal">
    <div v-if="show" class="fixed inset-0 z-[60] flex items-center justify-center px-4" @click.self="close">
      ...
      <!-- Modal Content -->
      <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 max-w-md w-full text-center transform transition-all scale-100 border border-gray-100 dark:border-gray-700">
        <!-- Success Icon -->
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
          Artikel anda sedang ditinjau oleh admin. Silahkan masuk ke menu lalu klik 'Artikel Saya' untuk melihat prosesnya.
        </p>
